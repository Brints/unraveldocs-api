...
import com.extractor.unraveldocs.team.datamodel.OrganizationMemberRole;
import com.extractor.unraveldocs.team.datamodel.OrganizationSubscriptionType;
import com.extractor.unraveldocs.team.dto.request.InviteMemberRequest;
import com.extractor.unraveldocs.team.dto.response.OrganizationMemberResponse;
import com.extractor.unraveldocs.team.model.Organization;
import com.extractor.unraveldocs.team.model.OrganizationInvitation;
import com.extractor.unraveldocs.team.model.OrganizationMember;
import com.extractor.unraveldocs.team.repository.OrganizationInvitationRepository;
import com.extractor.unraveldocs.team.repository.OrganizationMemberRepository;
import com.extractor.unraveldocs.team.repository.OrganizationRepository;
...
public class InvitationServiceImpl {
    ...
    public UnravelDocsResponse<String> inviteMember(String orgId, InviteMemberRequest request, String adminId) {
        log.info("Inviting {} to team {} by {}", request.getEmail(), orgId, adminId);
        ...
        log.info("Invitation sent to {} for team {}", request.getEmail(), orgId);
    ...
    public UnravelDocsResponse<OrganizationMemberResponse> acceptInvitation(String token, String userId) {
        ...
        log.info("User {} accepted invitation and joined team {}", userId, org.getId());
