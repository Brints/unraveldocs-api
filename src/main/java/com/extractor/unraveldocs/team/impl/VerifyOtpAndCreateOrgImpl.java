...
import com.extractor.unraveldocs.team.dto.request.VerifyOrgOtpRequest;
import com.extractor.unraveldocs.team.dto.response.OrganizationResponse;
import com.extractor.unraveldocs.team.model.Organization;
import com.extractor.unraveldocs.team.model.OrganizationMember;
import com.extractor.unraveldocs.team.model.OrganizationOtpVerification;
import com.extractor.unraveldocs.team.repository.OrganizationMemberRepository;
import com.extractor.unraveldocs.team.repository.OrganizationOtpRepository;
...
public class VerifyOtpAndCreateOrgImpl {
    ...
    public UnravelDocsResponse<OrganizationResponse> verifyAndCreate(VerifyOrgOtpRequest request, String userId) {
        log.info("Verifying OTP for team creation. User: {}", userId);
