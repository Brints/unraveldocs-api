...
import com.extractor.unraveldocs.team.dto.request.AddMemberRequest;
import com.extractor.unraveldocs.team.dto.request.RemoveMembersRequest;
...
public class MemberManagementImpl {
    ...
    public UnravelDocsResponse<Void> removeMembers(String orgId, RemoveMembersRequest request, String adminId) {
        ...
        log.info("{} members removed from team {} successfully", sanitizer.sanitizeLoggingInteger(request.getUserIds().size()), sanitizer.sanitizeLogging(orgId));
